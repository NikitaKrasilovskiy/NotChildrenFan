...
public class Anim_Ladder_Teleport_Down : StateMachineBehaviour
{
    ...
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.gameObject.GetComponentInParent<BoyMovement>().LadderCameraDown = true;
    }
    ...
    public override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.gameObject.GetComponentInParent<BoyMovement>().LadderCameraDown = false;
