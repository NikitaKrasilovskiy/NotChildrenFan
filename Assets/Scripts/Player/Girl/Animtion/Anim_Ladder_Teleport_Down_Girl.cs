...
public class Anim_Ladder_Teleport_Down_Girl : StateMachineBehaviour
{
    ...
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.gameObject.GetComponentInParent<GirlMovement>().LadderCameraDown = true;
    }
    ...
    public override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.gameObject.GetComponentInParent<GirlMovement>().LadderCameraDown = false;
        animator.gameObject.GetComponentInParent<GirlMovement>().CameraStandart();
    }
}
