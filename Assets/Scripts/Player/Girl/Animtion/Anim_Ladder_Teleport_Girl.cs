...
public class Anim_Ladder_Teleport_Girl : StateMachineBehaviour
{
    ...
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.gameObject.GetComponentInParent<GirlMovement>().LadderCameraUp = true;
    }
    ...
    public override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.gameObject.GetComponentInParent<GirlMovement>().LadderCameraUp = false;
