...
public class Dinamit_zone_02 : EnvirInterBoyGirl_Class
{
    private bool isBoy;
    private bool isGirl;
    private bool girlOn;
    ...
    public override void EnvirWorck()
    {
        ...
        if (isBoy == true && girlOn == true)
        {
            ...
            scaneData.dinamitOn[1] = true;
            scaneData.Dinamit_02On();
    ...
    {
        if (scaneData.dinamitOn[1] == false)
        {
        ...
        else if (scaneData.dinamitOn[1] == true)
        {
            infoButRef.SetActive(false);
        }
    }
